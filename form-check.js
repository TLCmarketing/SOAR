...
//------------ hashID for better session tracking. collectionEmaillogName for EmailLog System -------//
var hashID = Math.random().toString(36).substring(7),
    collectionEmaillogName = 'TLC Student Housing Landing Page',
    firstEntry = true;
//-------------//
...
$('form').on("keyup focusout", function(e) {
    ...
    if (firstEntry) {
      sendGA('event', 'SubmissionForm', 'firstEntry', '#'+hashID);
      firstEntry = false;
    }
...
function submitForm(e) {
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('.form').html('<div class="success">Thank you for your submission!</div>');
        },
